      ...
      <section class="main-padding">
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-4">
              <form action="../order_controllers/admin_controller.php" method="POST">
                <div class="orders-panel">
                  ...
                  <!-- ./total-price -->
                  <!-- confirm -->
                  <input type="number" id="id" name="user_id" value="<?= $_SESSION['user_id']?>" hidden>
                  <div class="confirm">
